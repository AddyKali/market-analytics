...
Users can manage a portfolio and view essential risk metrics with interactive visualizations.
...
Note: This project uses static CSV market data for academic demonstration and does not provide real-time trading signals.
...
Interactive Equity Curve Chart (Charts.js)
...
Equity Curve	Cumulative product of returns
...
Support for multiple stocks	Planned
📌 Disclaimer

This platform is meant for educational use only
and not for actual investment or trading decisions.

⭐ Show Support

If you like the project:
⭐ Star it on GitHub (when uploaded)

📍 License

MIT License — Free to modify & improve 🎓
